...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
        ...
        // document.querySelectorAll(".randomPizzaContainer") has been moved out 
        // of the for loop and assigned a variable name called 
        // randomPizzaContainer which means that property or the element is 
        // read once and then used/written in the for loop. This reduces the 
        // Forced Synchronous Layout(FSL) from happening which improves the 
        // performance.
...
// document.getElementById("randomPizzas") has been moved out of the for loop
// as it reduces the Forced Synchronous Layout(FSL)
...
function updatePositions() {
    ...
    // document.body.scrollTop has been popped out of the for loop as reduces 
    // Forced Synchronus Layout(FSL). So now the javascript reads the property
    // once and then start to write which enables FSL.
...
document.addEventListener('DOMContentLoaded', function() {
    var cols = 8;
    var s = 256;
    // document.querySelector("#movingPizzas1") has been moved out of the for 
    // loop as this particular element has been read only once rather than read 
    // in each iteration. It improves the performance.
